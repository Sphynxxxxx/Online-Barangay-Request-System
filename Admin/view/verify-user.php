...
if (!isset($_SESSION['user_id']) || !isset($_SESSION['user_type']) || $_SESSION['user_type'] != 'admin') {
    ...
    $_SESSION['error_msg'] = "You must be logged in as an administrator to access this page.";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && isset($_POST['user_id'])) {
    ...
    if ($conn->connect_error) {
        ...
        if ($stmt->execute()) {
            ...
            $logStmt = $conn->prepare("INSERT INTO admin_logs (admin_id, action, target_id, details, ip_address) VALUES (?, ?, ?, ?, ?)");
            $details = "User ID: $userId status changed to $status";
            $actionType = "user_$action";
            $logStmt->bind_param("isiss", $adminId, $actionType, $userId, $details, $ipAddress);
            $logStmt->execute();
            $logStmt->close();
        } else {
            $showAlert = true;
...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="../view/logout.php"><i class="bi bi-box-arrow-right me-2"></i>Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="sidebar">
        <div class="pt-2 pb-4">
            ...
            <a href="dashboard.php" class="d-block text-decoration-none text-white sidebar-item">
